    ...
    return(
        <Box px={{base:2,md:6}}>
            <SimpleGrid 
                ...
                gap={{base: 10,lg: 0}}
            >
                <VStack className="color" alignItems={{base:"center",sm:"flex-start"}}
                spacing={10} justifyContent="center" flexDirection="column">
                   <Box textAlign={{base:"center",sm:"left"}}>
                        <Box mb={3} as="h1" maxWidth="43rem" 
                   ...
                   <Button href="/" variant="brand" as={Link} size="lg" shadow="xl" rightIcon={<HiArrowRight />}>
                        Start Creating Now
                   </Button>
                </VStack>
